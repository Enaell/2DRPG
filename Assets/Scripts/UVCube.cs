    ...
    public void ApplyTexture()
    {
        ...
        if (mf)
        {
            ...
            if (mesh)
            {
                ...
                uvs[22] = new Vector2(tileSize * 2.001f, 1f);
                uvs[23] = new Vector2(tileSize * 2.001f, 0f);
                uvs[21] = new Vector2(tileSize * 1.001f, 1f);
                ...
                uvs[18] = new Vector2(tileSize * 4.001f, 1f);
                uvs[19] = new Vector2(tileSize * 4.001f, 0f);
                uvs[17] = new Vector2(tileSize * 3.001f, 1f);
                ...
                uvs[14] = new Vector2(tileSize * 6.001f, 1f);
                uvs[15] = new Vector2(tileSize * 6.001f, 0f);
                uvs[13] = new Vector2(tileSize * 5.001f, 1f);
